...
const MESSAGES = [
  ...
  "Storage strength refers to how well a memory is stored for the long term. What you ate last night probably has low storage strength, while your phone number has high storage strength.",
  "High storage strength means that retrieval strength decreases more slowly, and returns more quickly even after forgetting.",
